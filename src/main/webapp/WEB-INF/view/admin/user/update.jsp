                                        ...
                                        <div class="col-md-6 mx-auto">
                                            ...
                                            <form:form class="row" method="post" action="/admin/user/update"
                                                ...
                                                <div class="mb-3 col-12 col-md-6">
                                                    ...
                                                    <input type="file" class="form-control" id="avatarFile" name="nhatFile" accept=".png, .jpg, .jpeg" />
                                                </div>
                                                <div class="col-12 mb-3">
                                                    <img id="avatarPreview" alt="Avatar Preview" style="max-width: 200px; display: none;" />
                                                </div>
